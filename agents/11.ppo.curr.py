...
dodge_reset_parameters = \
    [
        {"ballSpeed": 2, "ballNums": 5, "ballRandom": 0.2, "randomSeed": 77, "agentSpeed": 30},
        {"ballSpeed": 2, "ballNums": 10, "ballRandom": 0.2, "randomSeed": 77, "agentSpeed": 30},
        {"ballSpeed": 2, "ballNums": 15, "ballRandom": 0.2, "randomSeed": 77, "agentSpeed": 30},
    ]
        ...
        if done[0]:
          ...
          # 게임 진행 상황 출력 및 텐서 보드에 보상과 손실함수 값 기록
            if episode % print_interval == 0:
                ...
                mean_actor_loss = np.mean(actor_losses) if len(
                    actor_losses) > 0 else 0
