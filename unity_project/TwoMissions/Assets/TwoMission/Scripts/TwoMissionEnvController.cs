...
public class TwoMissionEnvController : MonoBehaviour
{
    public TwoMissionAgent agent;
    ...
    private TwoMissionGoalDetect ballGoalDetector;
    ...
    public void InitializeEnv()
    {
        ...
        ballGoalDetector = ball.GetComponent<TwoMissionGoalDetect>();
        ballGoalDetector.ReachedBallGoal.AddListener(OnBallGoalReached);
    ...
    public void ResetScene()
    {
        ...
        switch (curGoal)
        {
            case GoalType.PushBall:
                ...
                pushBallRenderer.material = goalMateral;
                break;
            case GoalType.WallPass:
                wallPassRenderer.material = goalMateral;
        ...
        agentRb.transform.position = GetRandomSpawnPos(agentSpawnAreaBounds, agent.transform.position.y);
    ...
    {
        return Physics.Raycast(ballRb.transform.position, Vector3.down, 20);
    }
}
